      ...
      <div className="max-w-[2400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-2 md:col-start-2 md:pl-8 border-l border-white/10 flex flex-col gap-6">
           ...
           <div className="pt-4 flex flex-wrap gap-4">
             <a href="#install" className="inline-flex items-center gap-2 bg-white text-black px-6 py-3 rounded text-lg font-medium hover:bg-white/90 transition-colors">
               Get Started <span>→</span>
             </a>
             {repoLink && (
               <a href={repoLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-white/20 text-white px-6 py-3 rounded text-lg font-medium hover:bg-white/5 transition-colors">
                 View Source
               </a>
             )}
           </div>
