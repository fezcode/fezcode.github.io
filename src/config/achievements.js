...
export const ACHIEVEMENTS = [
  ...
  },
  {
    id: 'system',
    title: 'System',
    description: 'Delete It. To make your computer run faster. (Don\'t actually do this).',
    icon: <QuestionMarkIcon size={32} weight="duotone" />,
    category: 'Secret',
  },
  {
  ...
  },
  {
    id: 'ocean',
    title: 'Ocean',
    description: 'and George Clooney and Matt Damon and Julia Roberts and Brat Pitt and Andy Garcia and Bernie Mac...',
    icon: <QuestionMarkIcon size={32} weight="duotone" />,
    category: 'Secret',
  },
  {
