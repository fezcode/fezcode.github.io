        ...
        <header className="mb-24 border-b border-[#1a1a1a] pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div className="space-y-4">
              <h1 className="text-6xl md:text-8xl font-playfairDisplay italic font-black text-[#1a1a1a] tracking-tighter leading-none">
                The Fasting Ledger
              </h1>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-4 font-mono">
                <label className="block text-xs text-[#1a1a1a]/60 uppercase tracking-widest font-bold">
                  Standard Fast Goal (Hours)
                </label>
                <input
                  type="number"
                  value={fastingData.settings.targetFastLength}
                  onChange={(e) =>
                    fastingData.setSettings({
                      ...fastingData.settings,
                      targetFastLength: parseInt(e.target.value),
                    })
                  }
              ...
              <div className="space-y-4 font-mono">
                ...
                <input
                  ...
                  onChange={(e) =>
                    fastingData.setSettings({
                      ...fastingData.settings,
                      goalCalories: parseInt(e.target.value),
                    })
                  }
                  className="w-full bg-transparent border-b-2 border-[#1a1a1a] p-4 text-[#1a1a1a] text-2xl font-black focus:outline-none"
                />
              ...
              >
                {activeTab === 'dashboard' && (
                  <Dashboard
                    ...
                    onAdjustFast={() =>
                      handleOpenAdjustModal(fastingData.activeFast)
                    }
                  />
                )}
                {activeTab === 'details' && (
                ...
                {activeTab === 'planner' && <Planner data={fastingData} />}
                {activeTab === 'database' && (
                  <FoodDatabase
                    data={fastingData}
