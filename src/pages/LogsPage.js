                          ...
                          {categories.map((category) => {
                            ...
                            return (
                              <button
                                ...
                                style={isSelected ? { borderColor: color, color: color, backgroundColor: `${color}10` } : {}}
                              >
                                {category}
                              </button>
                            );
      ...
      >
        <div className="font-mono text-sm space-y-6 text-gray-300">
           ...
           <div className="border border-white/10 p-4 bg-black">
              <h3 className="text-emerald-500 font-bold mb-4 uppercase tracking-widest border-b border-emerald-500/20 pb-2">Rating Scale</h3>
              <ul className="space-y-3">
                 ...
                 <li className="flex justify-between">
                    <span>4 Stars</span>
                    <span className="text-gray-500 uppercase">Highly Recommended</span>
                 </li>
                 <li className="flex justify-between">
                    <span>3 Stars</span>
                    <span className="text-gray-500 uppercase">Good / Worthwhile</span>
                 </li>
                 <li className="flex justify-between">
                    <span>2 Stars</span>
                    <span className="text-gray-500 uppercase">Flawed / Average</span>
                 </li>
                 <li className="flex justify-between">
                    <span>1 Star</span>
