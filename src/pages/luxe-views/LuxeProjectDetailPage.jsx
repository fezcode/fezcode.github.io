    ...
    <div className="min-h-screen bg-[#F5F5F0] text-[#1A1A1A] selection:bg-[#C0B298] selection:text-black">
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          <Link
            to="/projects"
            className="inline-flex items-center gap-2 mb-12 font-outfit text-xs uppercase tracking-widest text-[#1A1A1A]/40 hover:text-[#8D4004] transition-colors"
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 font-outfit text-xs uppercase tracking-widest text-[#1A1A1A]/50">
                <span className="flex items-center gap-2">
                  ...
                  {new Date(fullProject.date).getFullYear()}
                </span>
                <span>•</span>
            ...
            <div className="flex gap-4">
              {fullProject.demo_link && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 bg-[#1A1A1A] text-white px-6 py-3 rounded-full font-outfit text-xs uppercase tracking-widest hover:bg-[#8D4004] transition-colors"
                >
              ...
              {fullProject.repo_link && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 border border-[#1A1A1A]/10 px-6 py-3 rounded-full font-outfit text-xs uppercase tracking-widest hover:border-[#1A1A1A] transition-colors"
                >
      ...
      <div className="max-w-[1000px] mx-auto px-6 pb-32 relative z-20 bg-[#F5F5F0]">
        ...
        <div className="flex flex-wrap gap-2 mb-16 pt-12 border-t border-[#1A1A1A]/10">
          {fullProject.technologies?.map((tech) => (
            <span
              key={tech}
              className="bg-white border border-[#1A1A1A]/5 px-3 py-1 rounded-sm font-outfit text-xs text-[#1A1A1A]/60 uppercase tracking-wider"
            >
              {tech}
            </span>
          ))}
