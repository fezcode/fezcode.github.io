...
export default function SSG() {
  return (
    <div className="space-y-6 font-mono text-sm leading-relaxed">
      <p>
        <strong className="text-current">Static Site Generation (SSG)</strong> is the process of building your website's HTML pages at build time, rather than on every request.
      </p>
      ...
      <p>
        In Fezcodex, we use <code className="text-current">react-snap</code> to crawl our React routes and save them as static folders. This ensures that search engines and social media crawlers see the full content of the page immediately, without needing to execute JavaScript.
      </p>
