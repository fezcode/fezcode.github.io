    ...
    <div className="min-h-screen bg-[#050505] py-24 px-6 md:px-12 selection:bg-emerald-500/30 font-mono relative overflow-x-hidden">
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 border border-white/5 bg-white/[0.01] rounded-sm">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Choose between the high-contrast brutalist vault or the
                    sophisticated luxe interface.
                  </p>
                </div>
                <CustomDropdown
                  variant="brutalist"
          ...
          <Section
            id="typography"
            title="Discovery Log Typography"
            icon={<LayoutIcon />}
            delay={0.07}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 max-w-md">
                      Disables all Framer Motion animations across the
                      application for a faster, more stable experience.
                    </p>
                  </div>
                  <CustomToggle
                    id="reduce-motion"
          ...
          >
            <p className="mb-10 text-gray-500 font-mono text-[10px] uppercase tracking-[0.2em]">
              Apply experimental filters to the entire application. Combine with
              caution.
            </p>
          ...
          <Section
            id="dnd"
            title="DND Experience"
            icon={<FilmStripIcon />}
            delay={0.32}
          >
            <p className="mb-10 text-gray-500 font-mono text-[10px] uppercase tracking-[0.2em]">
              Fine-tune the immersive effects of the "From Serfs and Frauds"
              archives.
            </p>
          ...
          >
            <p className="mb-10 text-gray-500 font-mono text-[10px] uppercase tracking-[0.2em]">
              Verify notification delivery and visual signatures for different
              system alerts.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <button
                onClick={() =>
                  addToast({
                    title: 'Success',
                    message: 'Primary system sequence executed successfully.',
                    type: 'success',
                  })
                }
              ...
              <button
                onClick={() =>
                  addToast({
                    title: 'System Error',
                    message: 'Critical corruption detected in neural module.',
                    type: 'error',
                  })
                }
              ...
              <button
                onClick={() =>
                  addToast({
                    title: 'Legacy Mapped',
                    message:
                      'Classical data structure integrated into the archive.',
                    type: 'gold',
                  })
                }
              ...
              <button
                onClick={() =>
                  addToast({
                    ...
                    message:
                      'Remote connection established via protocol SSH_V2.',
                    type: 'techno',
                  })
                }
