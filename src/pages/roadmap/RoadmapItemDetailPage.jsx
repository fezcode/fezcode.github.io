  ...
  if (!roadmapItem) {
    return (
      <div className="min-h-screen bg-[#080808] flex flex-col items-center justify-center text-gray-400 gap-4">
        ...
        <Link to="/roadmap" className="text-white hover:underline text-sm">
          Return to Roadmap
        </Link>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#e5e5e5] font-sans selection:bg-indigo-500/30">
      <Seo
        ...
        description={
          roadmapItem ? roadmapItem.description : 'Details of a roadmap item.'
        }
        ...
        >
          <div>
            ...
            <div className="flex items-center gap-4 text-xs text-gray-500 mb-8">
              ...
              <span>•</span>
              <span>
                opened {new Date(roadmapItem.created_at).toLocaleDateString()}
              </span>
            </div>
          </div>
