...
const EchoChamberPage = () => {
        ...
        prev.map((post) => {
          if (post.id === postId) {
            return {
              ...
              comments: [
                ...post.comments,
                { id: Date.now(), user: botName, text: botComment },
              ],
            };
          }
          return post;
  ...
  const glassInput =
    'bg-white/5 backdrop-blur-md border border-white/10 rounded-full focus:outline-none focus:ring-2 focus:ring-pink-300 text-white placeholder-pink-100/50';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 font-sans text-white overflow-hidden relative selection:bg-pink-300 selection:text-pink-900">
      ...
      <div className="absolute top-6 left-6 z-50">
        <Link
          to="/apps"
          className={`${glassCard} px-6 py-3 flex items-center gap-2 hover:bg-white/20 transition-all text-xs font-bold font-mono tracking-widest uppercase`}
        >
      ...
      <div className="container mx-auto max-w-2xl px-4 py-20 relative z-10 flex flex-col h-screen">
        ...
        <div className="text-center mb-8">
          ...
          />
          <p className="text-pink-100 text-xl font-arvo opacity-90 italic">
            Where everyone agrees with you. Forever.
          </p>
        </div>
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-playfairDisplay font-bold text-xl leading-tight">
                        You
                      </h3>
                      <p className="text-xs font-mono text-pink-100 opacity-70 uppercase tracking-tighter">
                        {post.timestamp}
                      </p>
                    </div>
                  </div>
                ...
                {/* Post Content */}
                <p className="text-2xl font-arvo mb-6 font-medium leading-relaxed drop-shadow-sm">
                  {post.text}
                </p>
                    ...
                    {post.comments.map((comment) => (
                      ...
                      >
                        ...
                        <div className="bg-white/5 rounded-2xl px-4 py-2">
                          <span className="font-bold font-mono text-pink-200 block text-[10px] uppercase mb-1 tracking-wider">
                            @{comment.user}
                          </span>
