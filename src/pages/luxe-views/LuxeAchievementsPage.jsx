    ...
    <div className="min-h-screen bg-[#F5F5F0] text-[#1A1A1A] font-sans selection:bg-[#C0B298] selection:text-black pt-24 pb-20 overflow-x-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <div>
              ...
              <p className="font-outfit text-sm text-[#1A1A1A]/60 max-w-lg leading-relaxed italic">
                A chronological record of significant system interactions and
            ...
            <div className="w-full lg:w-96 space-y-4">
              <div className="flex justify-between items-end font-outfit text-[10px] uppercase tracking-widest text-[#1A1A1A]/40">
                ...
                <span className="text-xl font-playfairDisplay italic text-[#1A1A1A]">
                  {progressPercentage}%
                </span>
              </div>
        ...
        <div className="mb-20 flex justify-center">
          <div
            className={`inline-flex items-center gap-6 px-8 py-4 rounded-full border backdrop-blur-sm transition-all duration-500 ${
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="font-outfit text-[9px] uppercase tracking-[0.3em] opacity-50">
                Discovery Protocol
              </span>
            ...
            <Link
              to="/settings"
              className="ml-4 font-outfit text-[9px] uppercase tracking-widest underline underline-offset-4 hover:text-[#8D4004] transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredAchievements.map((achievement) => {
            ...
            const unlockedDate = isUnlocked
              ? new Date(unlockedData.unlockedAt)
              : null;
            ...
            return (
              ...
              >
                ...
                {/* Category Label */}
                <span
                  className={`mb-8 font-outfit text-[9px] uppercase tracking-[0.3em] ${
                ...
                <div className="relative mb-8">
                  ...
                  <div
                    className={`w-24 h-24 flex items-center justify-center rounded-full transition-all duration-700 ${
                      isUnlocked
                ...
                {/* Text Content */}
                <h3
                  className={`font-playfairDisplay text-2xl mb-3 leading-tight transition-all ${
                    isUnlocked
                      ? 'text-[#1A1A1A] group-hover:italic'
                      : 'text-[#1A1A1A]/20'
                  }`}
                >
                  {achievement.title}
                ...
                <p
                  className={`font-outfit text-xs leading-relaxed line-clamp-3 italic ${
        ...
        {filteredAchievements.length === 0 && (
          <div className="py-32 text-center border border-dashed border-[#1A1A1A]/10 rounded-sm">
            <p className="font-playfairDisplay italic text-2xl text-[#1A1A1A]/20">
