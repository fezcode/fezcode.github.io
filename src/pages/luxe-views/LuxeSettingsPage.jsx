...
const LuxeSettingsPage = () => {
  ...
  const handleClearStorage = () => {
    ...
    addToast({
      title: 'Success',
      message: 'All local data cleared. Restarting...',
      duration: 3000,
    });
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] text-[#1A1A1A] font-sans selection:bg-[#C0B298] selection:text-black pt-24 pb-20 overflow-x-hidden">
      <Seo
        title="Fezcodex | Preferences"
        description="Customize your digital experience."
      />
        ...
        <header className="mb-24 pt-12 border-b border-black/10 pb-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-8">
            <p className="font-outfit text-sm text-black/60 max-w-lg leading-relaxed">
              Adjust the system parameters to align with your personal aesthetic
        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-8">
                <div className="p-6 border-l-2 border-[#8D4004]/20 bg-white/40 space-y-4">
                  ...
                  <p className="font-outfit text-xs text-black/50 leading-relaxed mb-4">
                    Select the primary visual foundation for the system.
                  </p>
                  <CustomDropdown
                    variant="paper"
                    label="Select Theme"
                ...
                <div className="p-6 border-l-2 border-black/5 bg-white/20 space-y-4">
                  ...
                  <p className="mt-4 font-outfit text-sm text-black/40 italic leading-relaxed">
                    Note: Activating this is recommended for the Fezluxe theme,
                    as all internal applications currently utilize the Brutalist
                    design language.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 border-l-2 border-black/5 bg-white/20 space-y-4">
                ...
                />
                <p className="mt-4 font-outfit text-sm text-black/40 italic leading-relaxed">
                  Note: Homepage section prioritization is currently exclusive
                  to the Brutalist (Brufez) theme architecture.
                </p>
              </div>
            </div>
          </LuxeSection>
          ...
          >
            ...
            <p className="mt-8 font-outfit text-sm text-black/40 italic leading-relaxed">
              Note: Global font selection is currently exclusive to the
              Brutalist (Brufez) theme architecture. Fezluxe utilize fixed
              high-fidelity typography for structural integrity.
            </p>
          </LuxeSection>
          ...
          >
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-6 border-l-2 border-black/5 bg-white/20">
                <div>
                  <h3 className="font-playfairDisplay text-xl mb-1">
                    Reduce Motion
                  </h3>
                  <p className="font-outfit text-xs text-black/50 max-w-md leading-relaxed">
                    Disables all cinematic animations across the application for
            ...
            {isFalloutOverlay && (
              ...
              >
                <div className="flex items-center gap-6">
                  <span className="font-outfit text-[10px] uppercase tracking-widest text-black/40">
                    Variant
                  </span>
                  <CustomDropdown
                    variant="paper"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <button
                  ...
                  onClick={() =>
                    addToast({
                      title: `${test.label} Signature`,
                      message: `Verifying ${test.label} notification protocol.`,
                      type: test.type,
                    })
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 font-outfit text-xs uppercase tracking-widest bg-white border border-black/10 hover:bg-[#8D4004] hover:text-white transition-all"
                >
                  Reset Cache
                </button>
              </div>
          ...
          >
            <div className="p-8 border border-rose-500/20 bg-rose-500/5 rounded-sm flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="font-playfairDisplay text-3xl text-rose-900 mb-2">
                  Factory Reset
                </h3>
                <p className="font-outfit text-sm text-rose-900/60 leading-relaxed">
                  This operation will purge all local configurations,
                  preferences, and achievements. This action is irreversible.
                </p>
              </div>
              <button
