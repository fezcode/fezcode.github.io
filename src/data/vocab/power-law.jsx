...
export default function PowerLaw() {
  return (
    <div className="space-y-6 font-mono text-sm leading-relaxed">
      <p>
        A <strong className="text-current">Power Law</strong> is a functional relationship between two quantities, where a relative change in one quantity results in a proportional relative change in the other quantity, independent of the initial size of those quantities.
      </p>
      <p>
        In statistics, it often manifests as a <strong className="text-current">Long-Tail Distribution</strong>, where a small number of events (the "head") occur with high frequency, while a large number of events (the "tail") occur with low frequency.
      </p>
      ...
      <div className="space-y-8 my-6">
        ...
        <div className="border-l-2 border-yellow-500/50 pl-4 py-1">
          ...
          <ul className="space-y-3 text-xs text-gray-400">
            ...
            <li>
              <strong className="text-current block mb-1">Pareto Principle (80/20 Rule)</strong>
              A common manifestation where 80% of effects come from 20% of causes.
            </li>
            <li>
              <strong className="text-current block mb-1">Lack of "Average"</strong>
        ...
        <div className="border-l-2 border-green-500/50 pl-4 py-1">
          ...
          <ul className="space-y-3 text-xs text-gray-400">
            ...
            <li><strong className="text-current">Internet Traffic:</strong> A few websites (Google, YouTube) receive the vast majority of all traffic.</li>
          </ul>
        </div>
      </div>
    </div>
