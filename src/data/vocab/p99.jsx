...
export default function P99() {
  return (
    <div className="space-y-6 font-mono text-sm leading-relaxed">
      <p>
        <strong className="text-white">P99</strong> (or the 99th Percentile) is a statistical metric indicating the value below which 99% of the observations in a group of observations fall.
      </p>
      <p>
        In software engineering, it is widely used to measure <strong className="text-white">system latency</strong> and performance. If a system has a P99 response time of 500ms, it means that <strong className="text-white">99% of all requests</strong> are served in 500ms or less, while the remaining 1% (the outliers) take longer.
      </p>
      ...
      <div className="border border-white/10 p-6 my-6 bg-white/[0.02]">
        ...
        <div className="space-y-4 text-xs text-gray-400">
          <div className="flex flex-col gap-1">
            <span className="text-white font-bold uppercase tracking-wider">Average</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-white font-bold uppercase tracking-wider">P99</span>
