...
const GithubThumbnailGeneratorPage = () => {
  ...
  const brutalInputClass =
    'bg-black border-2 border-white/20 p-3 font-mono text-sm text-white focus:border-indigo-400 outline-none transition-all w-full placeholder-white/20 rounded-none uppercase tracking-widest';
  const brutalCardClass =
    'bg-black border-2 border-white/10 p-6 space-y-6 rounded-none relative';
  const brutalLabelClass =
    'font-mono text-[10px] font-bold text-indigo-400 uppercase tracking-widest flex items-center gap-2 border-b-2 border-white/10 pb-4 mb-4';
        ...
        <header className="mb-24">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div className="space-y-4">
              <BreadcrumbTitle
                title="Github Thumbnail Gen"
                slug="ghtg"
                variant="brutalist"
              />
              <p className="text-xl text-gray-400 max-w-2xl font-light leading-relaxed font-mono">
                Generate Professional Social Preview Images And Readme Headers
                For Your Projects.
              </p>
            </div>
            ...
            <div className={brutalCardClass}>
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  rows={3}
                  className={`${brutalInputClass} resize-none`}
          ...
          <div className="lg:col-span-9">
            <div className="lg:sticky lg:top-24">
              <div className="relative border-2 border-white/10 bg-[#0a0a0a] rounded-none overflow-hidden flex items-center justify-center shadow-2xl group min-h-[400px]">
                <canvas ref={canvasRef} className="w-full h-auto shadow-2xl" />
                <div className="absolute top-4 right-4 z-30 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    onClick={() => {
                      setRepoOwner('fezcodex');
                      setRepoName('project-genesis');
                      setTheme('modern');
                      setSupportUrl('github.com/fezcodex');
                    }}
