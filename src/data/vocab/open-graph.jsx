...
export default function OpenGraph() {
  return (
    <div className="space-y-6 font-mono text-sm leading-relaxed">
      <p>
        The <strong className="text-current">Open Graph (OG)</strong> protocol is a set of rules used to enable any web page to become a rich object in a social graph. It was originally created by Facebook.
      </p>
      ...
      <p>
        By using <strong className="text-current">Static Site Generation (SSG)</strong>, Fezcodex ensures these tags are hard-coded into the HTML of every page, allowing social media bots to read them even if they don't support JavaScript.
      </p>
    </div>
  );
}
