      ...
      <div className="mx-auto max-w-[1800px] px-6 py-20 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24">
          ...
          <div className="md:col-span-4">
            <h4 className="font-outfit text-xs font-bold uppercase tracking-widest text-[#1A1A1A]/40 mb-8">
              Directory
            </h4>
              ...
              {[
                ...
                <li key={link.to}>
                  <Link
                    to={link.to}
                    onClick={scrollToTop}
                    className="font-playfairDisplay text-xl text-[#1A1A1A]/80 hover:text-[#1A1A1A] hover:italic transition-all"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-4">
            ...
            <div className="p-6 border border-[#1A1A1A]/5 bg-white rounded-sm">
              <div className="flex items-center gap-3 mb-2 text-[#1A1A1A]/60">
                <CommandIcon size={16} />
                <span className="font-outfit text-[10px] uppercase tracking-widest">
                  Quick Actions
                </span>
              </div>
              <p className="font-outfit text-xs text-[#1A1A1A]/40">
                Press{' '}
                <kbd className="font-mono bg-[#1A1A1A]/5 px-1 rounded">
                  Cmd + K
                </kbd>{' '}
