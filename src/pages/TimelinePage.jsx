    ...
    const fetchMilestones = async () => {
      try {
        ...
        if (response.ok) {
          ...
          let eventList = [];
          if (parsed.timeline) {
            eventList = Array.isArray(parsed.timeline)
              ? parsed.timeline
              : [parsed.timeline];
          }
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#050505] text-white selection:bg-emerald-500/30">
      <Seo
        ...
        ogImage="/images/asset/timeline-page.webp"
      />
      <div
            ...
            <div className="flex flex-col gap-1">
              ...
              {hoveredMilestone && (
                ...
                >
                  ...
                  <div
                    className="text-xl lg:text-2xl font-bold uppercase tracking-tight leading-none"
                    style={{ color: activeColor }}
                  >
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="flex flex-col gap-4 text-right">
              <div className="hidden md:block">
                ...
                >
                  <GlobeHemisphereWestIcon />{' '}
                  {hoveredMilestone ? hoveredMilestone.type : 'ALL SECTORS'}
                </div>
              </div>
              <div>
                <div className="font-mono text-[10px] text-gray-500 uppercase tracking-widest mb-1">
                ...
                <div className="font-mono text-sm text-white uppercase tracking-wider flex items-center justify-end gap-2">
                  ...
                  />
                  {hoveredMilestone
                    ? `OP-${hoveredMilestone.title.substring(0, 8).replace(/\s/g, '-')}`
                    : 'OP-TIMELINE'}
                </div>
              </div>
            </div>
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    borderColor: isHovered ? eventColor : `${eventColor}44`,
                  }}
                >
                ...
                >
                  ...
                  <h2 className="text-xl md:text-2xl font-black uppercase tracking-tight text-white mb-3 transition-colors font-sans">
                    <span
