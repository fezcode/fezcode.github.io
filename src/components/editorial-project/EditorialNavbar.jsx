    ...
    <nav className="border-b border-white/10 relative z-20 bg-black/50 backdrop-blur-sm">
      <div className="max-w-[2400px] mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          <span className="font-instr-serif italic text-2xl text-white tracking-tighter">
            Fezcodex
          </span>
        </Link>
        ...
        <div className="flex items-center gap-6 text-sm font-medium text-white/70">
          ...
          <a
            href={repoLink || 'https://github.com/fezcode'}
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white text-black px-3 py-1.5 rounded hover:bg-white/90 transition-colors"
          >
            GitHub
          </a>
        </div>
