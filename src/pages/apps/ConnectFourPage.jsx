          ...
          <div className="mt-8 flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            <div className="flex gap-12 font-mono">
              <div className="flex flex-col">
                ...
                <span
                  className={`text-3xl font-black ${currentPlayer === 1 ? 'text-emerald-500' : 'text-white'}`}
                >
            ...
            <div className="bg-white/5 border border-white/10 p-6 rounded-sm">
              ...
              <ul className="space-y-3 text-xs font-mono text-gray-500 uppercase tracking-wider">
                <li className="flex gap-3">
                  <span className="text-emerald-500">01</span> Connect four
                  pieces in any direction.
                </li>
                <li className="flex gap-3">
                  <span className="text-emerald-500">02</span> Block your
                  opponent's progression.
                </li>
                <li className="flex gap-3">
                  <span className="text-emerald-500">03</span> Gravity applies:
            ...
            <div className="bg-white/[0.01] border border-white/10 p-4 md:p-8 rounded-sm overflow-x-auto flex justify-center">
              <div className="grid grid-cols-7 gap-2 md:gap-4 w-full max-w-4xl">
                {board[0].map((_, colIdx) => (
                  ...
                  >
                    <div
                      className={`w-1.5 h-6 md:h-10 transition-all ${currentPlayer === 1 ? 'bg-emerald-500/20 group-hover/btn:bg-emerald-500' : 'bg-white/20 group-hover/btn:bg-white'}`}
                    />
                  </button>
                ))}
