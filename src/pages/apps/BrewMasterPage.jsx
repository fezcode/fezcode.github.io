...
const COFFEE_TYPES = [
  {
    ...
    layers: [
      { color: '#3E2723', height: 40, label: 'Pure Espresso', type: 'coffee' },
    ],
    origin: 'Italy',
    temp: '94°C',
    ratio: '1:2',
    trivia:
      'A perfect espresso has a "crema" – a creamy, reddish-brown froth on top.',
    description:
      'The pure soul of coffee. Intense, bold, and brewed under high pressure for the ultimate kick.',
  },
  {
    id: 'latte',
    name: 'Creamy Latte',
    ...
    ratio: '1:3',
    trivia:
      'Latte art is created by pouring microfoam into a shot of espresso.',
    description:
      'A gentle balance of rich espresso and velvety steamed milk, finished with a delicate layer of foam.',
  },
  {
    id: 'cappuccino',
    ...
    ratio: '1:1:1',
    trivia:
      'Named after the Capuchin friars, as the color of the drink resembles their robes.',
    description:
      'The perfect harmony of three: equal parts espresso, steamed milk, and airy foam.',
  },
  {
    id: 'flat-white',
    ...
    ratio: '1:2',
    trivia:
      'It’s all about the texture. The milk is "flat" because the bubbles are tiny and silky.',
    description:
      'For those who love the strength of espresso but want the silkiness of perfectly textured milk.',
  },
  {
    id: 'americano',
    ...
    ratio: '1:2',
    trivia:
      'American soldiers in WWII diluted Italian espresso to mimic the coffee from back home.',
    description:
      'A smooth, longer drink that lets the nuanced flavors of the espresso shine through.',
  },
  {
    id: 'turkish-coffee',
    ...
    ratio: '1:10',
    trivia:
      'A cup of coffee is remembered for 40 years of friendship in Turkish culture.',
    description:
      'Brewed in a cezve, this unfiltered treasure is famous for its thick foam and soul-warming intensity.',
  },
  {
    id: 'macchiato',
    ...
    ratio: '4:1',
    trivia:
      '"Macchiato" means "marked" or "stained." It’s an espresso marked with a small dollop of foam.',
    description:
      'For those who want a bold espresso experience but with a touch of softness from a single mark of foam.',
  },
  {
    id: 'mocha',
    name: 'Velvet Mocha',
    ...
    ratio: '1:1:2',
    trivia:
      'The name "Mocha" comes from the Red Sea port city of Mocha in Yemen, once the center of the coffee trade.',
    description:
      'The ultimate dessert-coffee. A rich, chocolatey embrace blended with deep espresso and smooth milk.',
  },
  {
    id: 'cortado',
    ...
    ratio: '1:1',
    trivia:
      '"Cortado" comes from the Spanish verb "cortar" (to cut), referring to the milk cutting through the espresso.',
    description:
      'A perfect 1:1 ratio. It is designed to reduce the acidity of the espresso while keeping its bold character.',
  },
  {
    id: 'vienna',
    name: 'Vienna Coffee',
    ...
    ratio: '2:1',
    trivia:
      'In Vienna, this is known as "Einspänner," named after the one-horse carriages of old Vienna.',
    description:
      'A sophisticated classic. Strong black coffee topped with a thick, cool layer of stiff whipped cream.',
  },
];
...
const BrewMasterPage = () => {
  ...
  const prev = () =>
    setIndex((prev) => (prev - 1 + COFFEE_TYPES.length) % COFFEE_TYPES.length);
  ...
  return (
    <div className="min-h-screen bg-[#1b120f] text-[#ede0d4] selection:bg-[#7b3f00]/30 font-sans overflow-hidden">
      <Seo
        title="Fez Coffee House | Discover Your Brew"
        description="Explore the art of coffee in our cozy digital corner."
      />
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-12 relative z-10">
        <header className="mb-12 text-center md:text-left">
          <Link
            to="/apps"
            className="group mb-8 inline-flex items-center gap-2 text-sm font-medium text-[#a68a64] hover:text-[#ede0d4] transition-colors"
          >
            <ArrowLeftIcon
              weight="bold"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col items-center justify-center min-h-[600px] relative">
            ...
            <div className="relative flex items-center justify-center w-full">
              <button
                onClick={prev}
                className="absolute left-[-20px] md:left-0 z-20 p-4 bg-[#3e2723]/80 hover:bg-[#5d4037] text-[#ede0d4] border border-[#a68a64]/20 shadow-xl transition-all rounded-full group"
              >
              ...
              <div className="relative w-80 h-96 flex flex-col items-center">
                ...
                <div className="relative w-64 h-80 mt-12">
                  ...
                  >
                    ...
                    {/* Cup Body */}
                    <path
                      d="M 40,40 L 160,40 L 155,165 Q 150,175 140,175 L 60,175 Q 50,175 45,165 Z"
                      fill="#fff"
                      fillOpacity="0.05"
                      stroke="#ede0d4"
                      strokeWidth="3"
                    />
                    <path
                      d="M 160,70 Q 190,70 190,100 Q 190,130 160,130"
                      fill="none"
                      stroke="#ede0d4"
                      strokeWidth="6"
                      strokeLinecap="round"
                    ...
                    <g clipPath="url(#cup-clip)">
                      {activeType.layers.map((layer, i) => {
                        const prevHeights = activeType.layers
                          .slice(0, i)
              ...
              <button
                onClick={next}
                className="absolute right-[-20px] md:right-0 z-20 p-4 bg-[#3e2723]/80 hover:bg-[#5d4037] text-[#ede0d4] border border-[#a68a64]/20 shadow-xl transition-all rounded-full group"
              >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="p-8 bg-[#3e2723]/40 border border-[#a68a64]/10 rounded-2xl shadow-2xl backdrop-blur-sm space-y-6">
                  ...
                  <p className="text-[#ede0d4]/90 leading-relaxed text-lg font-light">
                    {activeType.description}
                  </p>

                  <div className="grid grid-cols-2 gap-6 pt-6 border-t border-[#a68a64]/10">
                    <div>
                      <span className="text-[#a68a64] text-xs uppercase font-bold block mb-1">
                        Origin
                      </span>
                      <span className="text-[#ede0d4] text-lg font-medium italic">
                        {activeType.origin}
                      </span>
                    </div>
                    <div>
                ...
                <div className="p-8 bg-[#7b3f00]/10 border border-[#a68a64]/20 rounded-2xl space-y-4">
                  ...
                  <p className="text-[#ede0d4] italic text-lg leading-relaxed">
                    "{activeType.trivia}"
                  </p>
                </div>

                <div className="p-8 bg-black/20 border border-[#a68a64]/10 rounded-2xl">
                  <h3 className="text-xs font-bold text-[#a68a64] uppercase tracking-widest mb-6">
                    What's Inside?
                  </h3>
                    ...
                    {activeType.layers.map((layer, i) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          />
                          <span className="text-[#ede0d4]/80 text-sm font-medium">
                            {layer.label}
                          </span>
                        </div>
                        <span className="text-[#a68a64] font-mono text-sm">
                          {layer.height}%
                        </span>
                      </div>
                    ))}
        ...
        <footer className="mt-20 pt-10 border-t border-[#a68a64]/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-[#a68a64] text-xs uppercase font-bold tracking-widest">
            <span className="flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${isPouring ? 'bg-[#a68a64] animate-ping' : 'bg-[#3e2723]'}`}
              />
