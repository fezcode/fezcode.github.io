...
export default function PropDrilling() {
  return (
    <div className="space-y-4">
      <p>
        <strong>Prop Drilling</strong> (also known as "threading") refers to the
      ...
      <p>
        <strong>Solution:</strong> Use the <em>Context API</em>, <em>Redux</em>,
        or similar state management libraries to make data accessible to any
        component in the tree without manual passing.
      </p>
    </div>
  );
}
