...
const SynergyFlowPage = () => {
  ...
  const generateSynergy = useCallback(() => {
    const v =
      BUZZWORDS.verbs[Math.floor(Math.random() * BUZZWORDS.verbs.length)];
    const a =
      BUZZWORDS.adjectives[
        Math.floor(Math.random() * BUZZWORDS.adjectives.length)
      ];
    const n =
      BUZZWORDS.nouns[Math.floor(Math.random() * BUZZWORDS.nouns.length)];
    const s =
      Math.random() > 0.7
        ? ` ${BUZZWORDS.suffixes[Math.floor(Math.random() * BUZZWORDS.suffixes.length)]}`
        : '';

    setPhrase(`${v} ${a} ${n}${s}.`);
    setColor(
      CORPORATE_COLORS[Math.floor(Math.random() * CORPORATE_COLORS.length)],
    );
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-blue-200 selection:text-blue-900 overflow-hidden relative">
      ...
      <div className="absolute top-4 left-4 z-50">
        <Link
          to="/apps"
          className="px-6 py-3 bg-black text-white font-mono uppercase text-sm tracking-widest hover:bg-gray-800 transition-colors flex items-center gap-2 rounded-full shadow-lg"
        >
      ...
      <div className="container mx-auto px-4 h-screen flex flex-col md:flex-row items-center justify-center relative z-10">
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center p-8 relative">
          ...
          >
            ...
            <svg
              viewBox="0 0 200 200"
              className="w-full h-full absolute top-0 left-0 text-opacity-20"
              style={{ color: color, fill: 'currentColor' }}
            >
              {shape === 0 && (
                <path
                  d="M44.7,-76.4C58.9,-69.2,71.8,-59.1,79.6,-46.9C87.4,-34.7,90.1,-20.4,85.8,-7.1C81.5,6.2,70.2,18.5,60.2,28.8C50.2,39.1,41.5,47.4,31.9,54.6C22.3,61.8,11.8,67.9,-0.8,69.3C-13.4,70.7,-25.1,67.4,-36.3,60.8C-47.5,54.2,-58.2,44.3,-66.1,32.4C-74,20.5,-79.1,6.6,-77.3,-6.4C-75.5,-19.4,-66.8,-31.5,-56.3,-41.3C-45.8,-51.1,-33.5,-58.6,-20.9,-66.6C-8.3,-74.6,4.6,-83.1,17.2,-83.2C29.8,-83.3,42.1,-75,54.7,-66.7Z"
                  transform="translate(100 100)"
                />
              )}
              {shape === 1 && (
                <path
                  d="M38.9,-64.6C51.6,-59.1,64,-52.3,71.9,-42.2C79.8,-32.1,83.2,-18.7,81.3,-6.2C79.4,6.3,72.2,17.9,63.4,28C54.6,38.1,44.2,46.7,33.1,53.4C22,60.1,10.2,64.9,-1.4,67.3C-13,69.7,-24.3,69.7,-35.3,64.7C-46.3,59.7,-57,49.7,-64.6,37.8C-72.2,25.9,-76.7,12.1,-75.4,-1.1C-74.1,-14.3,-67,-26.9,-57.6,-36.8C-48.2,-46.7,-36.5,-53.9,-24.8,-60C-13.1,-66.1,-1.4,-71.1,10.6,-70.8C22.6,-70.5,35.2,-64.9,38.9,-64.6Z"
                  transform="translate(100 100)"
                />
              )}
        ...
        <div className="w-full md:w-1/2 p-8 text-center md:text-left z-20 flex flex-col items-center md:items-start">
          ...
          >
            <h1
              className="text-5xl md:text-7xl font-playfairDisplay font-bold mb-6 tracking-tight leading-tight"
              style={{ color: color }}
            >
              {phrase}
            </h1>
            <p className="text-gray-400 text-lg mb-8 italic font-arvo">
              ...
              {BUZZWORDS.adjectives[Math.floor(Math.random() * 5)]} engagement."
            </p>
