        ...
        <div className="flex flex-col gap-8 flex-grow mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-[#0a0a0a] p-6 border border-white/5 rounded-sm">
            <div className="space-y-4">
              <h3 className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/40 border-b border-white/5 pb-2">
                Source & Actions
              </h3>
            ...
            <div className="space-y-4 border-l border-white/5 pl-6">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                >
                  <div
                    className={`absolute top-1 w-3 h-3 bg-white rounded-full transition-all ${wireframe ? 'left-6' : 'left-1'}`}
                  />
                </button>
              </div>
