...
const CloudPlaylist = () => {
  const { playlist, currentTrack, isPlaying, playTrack, togglePlay } = useCloudMusic();
          ...
          return (
            ...
            >
              ...
              <div className="font-bold opacity-60 flex items-center justify-center">
                 {isCurrent ? (
                     isPlaying ? <WaveformIcon className="animate-pulse" size={16} /> : <PauseIcon size={16} />
                 ) : (
              ...
              <div className="min-w-0 flex flex-col">
                <span className={`font-bold truncate ${isCurrent ? 'text-cyan-300' : 'text-gray-300 group-hover:text-cyan-200'}`}>
                    {track.title}
                </span>
