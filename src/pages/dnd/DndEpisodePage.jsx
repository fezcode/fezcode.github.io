    ...
    <DndLayout>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-12">
            ...
            >
              <div className="dnd-stat-block shadow-2xl lg:sticky lg:top-40 group">
                ...
                <div className="absolute -bottom-8 left-0 w-full text-center opacity-0 group-hover:opacity-100 transition-opacity duration-1000 hidden md:block">
                  <span className="dnd-secret-text text-[8px] uppercase tracking-[0.2em]">
                    Don't believe the scribes
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="text-xs">
                      <span className="dnd-stat-block-label">
                        Special Trait.
                      </span>
                      <span className="italic ml-1">
                        Chronicler of the Realm.
                      </span>{' '}
                      This scribe adds their wisdom modifier to all storytelling
                      checks.
                    </div>
                    ...
                    {currentEpisode.updated && (
                      <div className="text-xs">
                        ...
                        <span className="ml-1 text-dnd-crimson/80 font-bold">
                          {currentEpisode.updated}
                        </span>
                      </div>
                    )}
            ...
            >
              ...
              <div className="absolute top-1/4 -left-4 -rotate-90 pointer-events-none hidden md:block">
                <span className="dnd-secret-text text-[10px] uppercase tracking-[1em]">
                  The walls have eyes
                </span>
              </div>
              ...
              <div className="mt-12 md:mt-20 pt-8 md:pt-12 border-t border-black/5 relative z-10 flex flex-col items-end opacity-60">
                <span className="font-playfairDisplay italic text-xl md:text-2xl text-dnd-crimson mb-2">
                  {currentEpisode.author}
                </span>
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-between gap-8 pt-12 border-t border-white/10">
            ...
            {prevEpisode && (
              ...
              >
                ...
                <CaretLeftIcon
                  size={24}
                  weight="bold"
                  className="text-dnd-crimson group-hover:scale-125 transition-transform"
                />

                <div className="flex flex-col text-left relative z-10">
                  <span className="text-[8px] font-mono uppercase tracking-widest text-black/40">
                    Prior Entry
                  </span>

                  <span className="text-sm font-arvo font-bold text-dnd-crimson line-clamp-1">
                    {prevEpisode.title}
                  </span>
                </div>
              </Link>
          ...
          <Link
            to="/stories/lore"
            className="group relative flex items-center justify-center gap-3 px-10 py-5 dnd-parchment-container border-2 border-black/10 hover:border-dnd-gold/50 transition-all shadow-xl hover:-translate-y-1 min-w-[240px] overflow-hidden"
          >
            <div className="absolute top-0 left-0 w-4 h-4 border-t border-l border-dnd-gold opacity-40 group-hover:opacity-100" />
            ...
            <span className="font-mono font-black text-xs tracking-[0.4em] text-dnd-crimson">
              Show Index
            </span>
          </Link>
