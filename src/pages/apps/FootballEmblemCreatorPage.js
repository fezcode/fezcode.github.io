...
const FootballEmblemCreatorPage = () => {
  useSeo({
    ...
    ogDescription: 'Create custom football emblems and logos.',
    twitterCard: 'summary_large_image',
    twitterTitle: 'Football Emblem Creator | Fezcodex',
    twitterDescription: 'Create custom football emblems and logos.',
  });
            ...
            <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 shadow-2xl relative">
              ...
              >
                ...
                <g transform="translate(30, 30)">
                  {React.cloneElement(icons[selectedIcon], {
                    size: 40,
                    color: accentColor,
                    weight: 'fill',
                  })}
