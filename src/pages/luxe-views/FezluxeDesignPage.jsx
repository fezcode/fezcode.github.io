    ...
    openSidePanel(
      ...
      <div className="space-y-8">
        <div className="p-6 border-l-2 border-[#8D4004]/20 bg-[#8D4004]/5">
          <h4 className="font-playfairDisplay text-xl italic text-[#1A1A1A] m-0">
            Refined_Data_Stream
          </h4>
          <p className="font-outfit text-[10px] text-[#1A1A1A]/40 uppercase tracking-widest mt-2">
            Synchronized with secondary vault.
          </p>
        </div>
        <p className="font-outfit text-sm text-[#1A1A1A]/70 leading-relaxed italic">
          The SidePanel in Luxe configuration emphasizes white space and
          typographic hierarchy, providing a sophisticated layer for deep-dive
          information.
        </p>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <header className="mb-32 pt-12 border-b border-black/10 pb-20 text-center">
          ...
          >
            FEZ
            <br />
            <span className="italic text-black/40">LUXE</span>
          </motion.h1>

          <div className="flex justify-center gap-12 text-[10px] font-outfit uppercase tracking-[0.4em] text-black/30">
            <span className="flex items-center gap-2">
              <FeatherIcon size={14} /> Sophistication
            </span>
            <span className="flex items-center gap-2">
              <SparkleIcon size={14} /> Precision
            </span>
            <span className="flex items-center gap-2">
              <CompassIcon size={14} /> Clarity
            </span>
          </div>
        </header>
          ...
          <div className="lg:col-span-7 space-y-32">
            <section className="space-y-12">
              <div className="flex items-center gap-6">
                <span className="font-playfairDisplay text-6xl text-[#1A1A1A]/10 italic">
                  01
                </span>
              ...
              <div className="prose prose-stone prose-lg max-w-none">
                <p className="text-2xl text-[#1A1A1A]/80 font-light leading-relaxed italic">
                  Fezluxe is the evolution of the digital sanctuary. It
                  transcends the "raw" to find the "refined"—where structure
                  becomes architectural and feedback becomes intuitive.
                </p>

                <div className="mt-20 space-y-20">
                  <div className="space-y-6">
                    <h4 className="font-playfairDisplay text-3xl text-[#1A1A1A]">
                      Refined Architecture
                    </h4>
                    <p className="font-outfit text-sm text-[#1A1A1A]/60 leading-relaxed">
                      Structure is defined by generous white space and soft
                      depth. We avoid the rigid 1PX grid in favor of subtle
                      borders (#1A1A1A/5) and sophisticated backdrops. Every
                      element breathes, creating a sense of calm and
                      intentionality.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="font-outfit text-sm text-[#1A1A1A]/60 leading-relaxed">
                      The palette centers on a soft Parchment (
                      <span className="text-[#8D4004] font-mono">#F5F5F0</span>)
                      and a deep Obsidian (
                      <span className="text-[#8D4004] font-mono">#1A1A1A</span>
                      ). Our accent, Burnished Amber (
                      <span className="text-[#8D4004] font-mono">#8D4004</span>
                      ), is used sparingly to draw focus without overwhelming
                      the senses.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="font-outfit text-sm text-[#1A1A1A]/60 leading-relaxed">
                      Fezluxe hides the "noise" but celebrates the "data".
                      Version IDs and timestamps are transformed into elegant
                      metadata tags. We use{' '}
                      <span className="italic text-[#8D4004]">
                        Sentence Case
                      </span>{' '}
                      and refined icons to treat information as a curated
                      exhibit.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/40 backdrop-blur-md border border-black/5 p-12 rounded-sm space-y-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-4">
                    <label className="font-outfit text-[10px] uppercase tracking-widest text-black/30">
                      Selection Interface
                    </label>
                    <CustomDropdown
                      fullWidth
                  ...
                  <div className="flex flex-col justify-end gap-6 pb-2">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-outfit text-[10px] uppercase tracking-widest text-black/60">
                        Active Status
                      </span>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="w-3 h-3 rounded-full bg-black/5" />
                      <span className="font-outfit text-[10px] uppercase tracking-widest text-black/30">
                        Standby Mode
                      </span>
                    </div>
                  </div>
            ...
            <section className="space-y-12">
              ...
              <div className="bg-white p-12 space-y-12 shadow-sm border border-black/5">
                <div className="space-y-2">
                  <span className="font-outfit text-[10px] text-[#8D4004] uppercase tracking-[0.3em]">
                    Serif Display
                  </span>
                  <h1 className="font-playfairDisplay text-6xl italic leading-none">
                    Fezluxe Core
                  </h1>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <h2 className="font-playfairDisplay text-3xl italic leading-none">
                    System Architecture
                  </h2>
                </div>
                ...
                <div className="grid grid-cols-1 gap-12 pt-8 border-t border-black/5">
                  <div className="space-y-4">
                    <span className="font-outfit text-[10px] text-black/30 uppercase tracking-[0.3em]">
                      Body Text / Sans
                    </span>
                    <p className="font-outfit text-sm text-black/70 leading-relaxed italic">
                      Used for prose and detailed descriptions. Chosen for its
                      balance of readability and sophisticated character.
                    </p>
                  </div>
                  <div className="space-y-4">
                    <span className="font-outfit text-[10px] text-black/30 uppercase tracking-[0.3em]">
                    ...
                    <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#8D4004]">
                      Reserved for cryptographic IDs, system constants, and
                      secondary metadata.
                    </p>
                  </div>
                </div>
                ...
                {[
                  {
                    ...
                    hex: '#F5F5F0',
                    bg: 'bg-[#F5F5F0]',
                    desc: 'Primary Foundation',
                  },
                  {
                    name: 'LUXE_OBSIDIAN',
                    hex: '#1A1A1A',
                    bg: 'bg-[#1A1A1A]',
                    desc: 'Primary Text & Contrast',
                  },
                  {
                    name: 'BURNISHED_AMBER',
                    hex: '#8D4004',
                    bg: 'bg-[#8D4004]',
                  ...
                  },
                  {
                    ...
                    hex: '#FDFCFB',
                    bg: 'bg-[#FDFCFB]',
                    desc: 'Surface Elevation',
                  },
                  {
                    name: 'LUXE_SILVER',
                    hex: '#EBEBEB',
                    bg: 'bg-[#EBEBEB]',
                    desc: 'Secondary Metadata',
                  },
                ].map((color) => (
                  <div
                    key={color.name}
                    className="bg-white p-6 flex items-center justify-between group hover:bg-[#F5F5F0] transition-colors"
                  >
                    <div className="flex items-center gap-6">
                      <div
                        className={`w-12 h-12 rounded-full border border-black/5 ${color.bg}`}
                      />
                      <div className="space-y-1">
                        <div className="text-xs font-bold font-outfit tracking-widest">
                          {color.name}
                        </div>
                        <div className="text-[10px] font-outfit text-black/30 uppercase tracking-widest">
                          {color.desc}
                        </div>
                      </div>
                    </div>
                    <div className="font-mono text-[10px] text-black/20 uppercase tracking-widest group-hover:text-[#8D4004] transition-colors">
                      {color.hex}
                    </div>
                  </div>
                ))}
              ...
              <div className="p-8 border border-black/5 bg-white/40 space-y-8">
                <div className="grid grid-cols-2 gap-4">
                  <button
                    onClick={() =>
                      addToast({
                        title: 'Integrity Sync',
                        message: 'Synchronization sequence complete.',
                        type: 'success',
                      })
                    }
                  ...
                  <button
                    onClick={() =>
                      addToast({
                        title: 'Milestone Discovered',
                        message: 'Rare system metric established.',
                        type: 'gold',
                      })
                    }
                  ...
                  <button
                    onClick={() =>
                      addToast({
                        ...
                        message: 'Anomalous drift detected in node 04.',
                        type: 'error',
                      })
                    }
                  ...
                  <button
                    onClick={() =>
                      addToast({
                        ...
                        message: 'Initializing Luxe design protocols.',
                        type: 'techno',
                      })
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    ...
                    className="py-4 bg-white border border-black/10 hover:border-[#8D4004] text-black/60 hover:text-[#8D4004] transition-all font-outfit text-[10px] uppercase tracking-widest rounded-sm"
                  >
                    Open Luxe Modal
                  </button>
                  <button
        ...
        <footer className="mt-48 pt-12 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-8 font-outfit text-[10px] uppercase tracking-[0.4em] text-black/30">
          ...
          <div className="text-right">
            <span>
              Synchronized with Mainframe: {new Date().toLocaleDateString()}
            </span>
          </div>
        </footer>
      </div>
      ...
      >
        <div className="space-y-8">
          <div className="inline-flex items-center gap-3 px-4 py-2 border border-black/10 rounded-full bg-[#F5F5F0]">
            ...
            <span className="font-outfit text-[10px] uppercase tracking-widest text-black/60">
              Modal_Protocol_Verified
            </span>
          </div>
          <p className="font-outfit text-lg italic text-[#1A1A1A]/80 leading-relaxed">
            The LuxeModal component features a refined parchment background,
            elegant typography, and a balanced usage of soft shadows to create a
            sophisticated focal point for critical information.
          </p>
