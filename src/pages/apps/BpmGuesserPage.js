...
const BpmGuesserPage = () => {
  useSeo({
    ...
    keywords: ['Fezcodex', 'BPM guesser', 'tap tempo', 'music tool', 'beat counter'],
    ogTitle: 'BPM Guesser | Fezcodex',
    ogDescription: 'Tap the beat to guess the BPM (Beats Per Minute) of a song.',
    ogImage: 'https://fezcode.github.io/logo512.png',
    twitterCard: 'summary_large_image',
    twitterTitle: 'BPM Guesser | Fezcodex',
    twitterDescription: 'Tap the beat to guess the BPM (Beats Per Minute) of a song.',
          ...
          >
            ...
            <div className="relative z-10 p-1 text-center">
              ...
              <div className="mb-8">
                ...
                <div className="text-sm opacity-60 uppercase tracking-wider">Beats Per Minute</div>
              </div>
