  ...
  const toggleMute = () => {
    ...
    Object.keys(volumes).forEach((id) => {
      if (audioRefs.current[id]) {
        audioRefs.current[id].volume =
          newMuted || mutedSounds[id] ? 0 : volumes[id];
      }
    });
  };
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-400 max-w-2xl font-light leading-relaxed">
                Soundscape calibration protocol. Mix environmental layers to
                generate a balanced auditory background for focus and clarity.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              {!isInitialized ? (
                ...
                >
                  {isMuted ? (
                    <SpeakerSlashIcon weight="bold" size={24} />
                  ) : (
                    <SpeakerHighIcon weight="bold" size={24} />
                  )}
          ...
          <div className="lg:col-span-12">
            <div className="relative border border-white/10 bg-white/[0.02] p-12 md:p-24 rounded-sm overflow-hidden group">
              <div className="absolute inset-0 opacity-[0.03] pointer-events-none grayscale">
                <GenerativeArt
                  seed={appName + Object.values(volumes).join('')}
                  ...
                  >
                        ...
                        <div className="w-16 h-full bg-black/40 border border-white/5 rounded-sm relative overflow-hidden flex flex-col justify-end">
                          ...
                          <input
                            ...
                            style={{
                              ...
                              width:
                                '384px' /* Match height of container (h-96 = 24rem = 384px) */,
                              height:
                                '64px' /* Match width of container (w-16 = 4rem = 64px) */,
                              position: 'absolute',
                    ...
                    >
                      <sound.icon
                        size={32}
                        weight={
                          volumes[sound.id] > 0 && !mutedSounds[sound.id]
                            ? 'fill'
                            : 'regular'
                        }
                      ...
                      <span
                        className={`block font-black ${mutedSounds[sound.id] ? 'text-red-500 line-through' : 'text-white'}`}
                      >
