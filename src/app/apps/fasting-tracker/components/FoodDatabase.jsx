    ...
    <div className="space-y-12 font-arvo">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 border-b border-[#1a1a1a]/10 pb-12">
        <div className="relative w-full md:w-[500px] group">
          <MagnifyingGlassIcon
            className="absolute left-4 top-1/2 -translate-y-1/2 text-[#1a1a1a]/30 group-focus-within:text-[#1a1a1a] transition-colors"
            size={24}
          />
        ...
        >
          ...
          {isAdding ? 'Discard Draft' : 'Add Custom Food'}
        </button>
      </div>
      ...
      {isAdding && (
        ...
        >
          <div className="absolute top-4 right-4 text-[8px] font-mono text-gray-300 uppercase tracking-widest">
            Entry Form
          </div>

          <h3 className="font-playfairDisplay text-2xl italic font-black text-[#1a1a1a] mb-10 border-b border-[#1a1a1a]/10 pb-4">
            New Food Entry
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 font-mono">
            <div className="space-y-2">
              <label className="text-[9px] font-black uppercase tracking-tighter text-gray-400">
                Description
              </label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {filteredFoods.map((food) => (
          <div
            key={food.id}
            className="border border-[#1a1a1a]/20 bg-white/5 p-8 hover:border-[#1a1a1a] hover:bg-white/20 transition-all group shadow-sm flex flex-col"
          >
            <div className="flex justify-between items-start mb-6 border-b border-[#1a1a1a]/5 pb-4">
              <h4 className="text-xl font-bold text-[#1a1a1a] group-hover:text-black transition-colors leading-tight">
                {food.name}
              </h4>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-between">
              <div>
                <div className="text-3xl font-mono font-black text-[#1a1a1a] mb-6">
                  {food.calories}{' '}
                  <span className="text-[10px] uppercase font-bold tracking-widest text-[#1a1a1a]/30">
                    kcal
                  </span>
                </div>
