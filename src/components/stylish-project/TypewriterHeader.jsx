...
const TypewriterHeader = ({
  words = ['developers', 'coders', 'hackers', 'builders'],
  prefix = 'Built for',
}) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-10">
      ...
      <div className="flex items-center space-x-2 mb-6 px-3 py-1 bg-product-card-bg/50 border border-white/5 rounded-full">
        <span className="font-mono text-product-card-icon text-sm">
          {statusData[symbolIndex].symbol}
        </span>
