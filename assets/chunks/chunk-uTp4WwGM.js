import{r,u as k,j as e,L as j}from"../entries/pages.BWQb9Xz5.js";import{S as N}from"./chunk-DZBIj8id.js";/* empty css              *//* empty css              */import"./chunk-BXl3LOEh.js";/* empty css              */const z=`
...
`,S=[[0,""],[40,"largo"],[60,"larghetto"],[66,"adagio"],[76,"andante"],[108,"moderato"],[120,"allegro"],[168,"presto"],[200,"prestissimo"]],M=t=>{let i="";for(const[x,s]of S)t>=x&&(i=s);return i},B=[40,50,60,72,88,104,126,160,208],P=()=>{const[t,i]=r.useState(0),[x,s]=r.useState([]),d=r.useRef(0),{unlockAchievement:l}=k(),c=r.useRef(0),n=r.useRef(0);r.useEffect(()=>{t===90&&l("on_the_beat")},[t,l]);const g=r.useCallback(()=>{const a=performance.now();if(d.current===0){d.current=a,s([]),i(0),n.current=0,c.current=0;return}const o=a-d.current;if(d.current=a,o>2e3){s([]),i(0),n.current=0,c.current=0;return}s(m=>{const p=[...m,o];p.length>8&&p.shift();const v=p.reduce((w,y)=>w+y,0)/p.length,h=Math.round(6e4/v);return p.length>3&&(h===c.current?(n.current+=1,n.current>=15&&l("human_metronome")):n.current=0),c.current=h,i(h),p})},[l]),f=()=>{s([]),i(0),d.current=0,n.current=0,c.current=0};r.useEffect(()=>{const a=o=>{if(o.code!=="Space"&&o.key!==" ")return;const m=(o.target.tagName||"").toLowerCase();m==="input"||m==="textarea"||o.target.isContentEditable||(o.preventDefault(),g())};return window.addEventListener("keydown",a),()=>window.removeEventListener("keydown",a)},[g]);const u=t>=30&&t<=260,_=u?120/t:1,b=(()=>{const a=Math.min(208,Math.max(40,t||40));return 8+(Math.log(a)-Math.log(40))/(Math.log(208)-Math.log(40))*84})();return e.jsxs("div",{className:"met",children:[e.jsx("style",{children:z}),e.jsx(N,{title:"BPM Guesser | Fezcodex",description:"Find the tempo of any song by tapping along to the beat.",keywords:["Fezcodex","BPM counter","tap tempo","music tools","metronome"]}),e.jsxs("div",{className:"met__shell",children:[e.jsxs(j,{to:"/apps",className:"met__back",children:[e.jsx("svg",{viewBox:"0 0 16 16",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("path",{d:"M10 3 L5 8 L10 13",strokeLinecap:"round",strokeLinejoin:"round"})}),"Back to apps"]}),e.jsx("h1",{className:"met__title",children:"BPM guesser"}),e.jsx("p",{className:"met__sub",children:"Tap along to a song and the weight slides to its tempo. Four taps is enough for a reading; keep going and it settles."}),e.jsx("div",{className:"met__stage",children:e.jsxs("div",{className:"met__case",children:[e.jsxs("div",{className:"met__slot",children:[e.jsx("div",{className:"met__scale","aria-hidden":"true",children:B.map(a=>e.jsxs("div",{className:"met__tick",children:[e.jsx("i",{}),a]},a))}),e.jsxs("div",{className:`met__rod-pivot${u?" met__rod-pivot--ticking":""}`,style:{"--period":`${_}s`},children:[e.jsx("div",{className:"met__rod",children:e.jsx("div",{className:"met__weight",style:{bottom:`${100-b}%`}})}),e.jsx("div",{className:"met__bob"})]})]}),e.jsxs("div",{className:"met__plaque",children:[e.jsxs("div",{className:"met__bpm",children:[t>0?t:"—"," ",e.jsx("span",{children:"bpm"})]}),e.jsx("div",{className:"met__mark",children:t>0?M(t):"waiting for a beat"})]})]})}),e.jsxs("div",{className:"met__controls",children:[e.jsx("button",{className:"met__tap",onMouseDown:g,children:"Tap"}),e.jsxs("p",{className:"met__hint",children:["or press ",e.jsx("kbd",{children:"space"})]})]}),e.jsxs("div",{className:"met__meta",children:[e.jsxs("span",{children:["Taps counted ",e.jsx("b",{children:x.length})]}),e.jsx("button",{className:"met__reset",onClick:f,children:"Start over"})]})]})]})};export{P as default};
