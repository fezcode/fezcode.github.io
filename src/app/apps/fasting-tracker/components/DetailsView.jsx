...
const DetailsView = ({ data, onAdjustFast }) => {
  ...
  const avgFastLength = completedFasts.length > 0
    ? completedFasts.reduce((acc, f) => acc + (f.end - f.start), 0) / completedFasts.length / (1000 * 60 * 60)
    : 0;

  const totalCalories = meals.reduce((acc, m) => acc + (m.calories || 0), 0);
  const avgDailyCalories = meals.length > 0
    ? totalCalories / (new Set(meals.map(m => new Date(m.timestamp).toDateString())).size || 1)
    : 0;
        ...
        <div className="space-y-16 font-arvo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="border border-[#1a1a1a] bg-white/5 p-10 shadow-sm relative overflow-hidden group">
                ...
                <h4 className="text-[10px] font-mono text-[#1a1a1a]/40 uppercase tracking-widest font-black mb-6">Average Duration</h4>

                <div className="flex items-end gap-3">

                    <span className="text-5xl font-black text-[#1a1a1a] tracking-tighter">{avgFastLength.toFixed(1)}</span>

                    <span className="text-xs font-mono text-[#1a1a1a]/60 mb-2 font-bold italic uppercase">Hours</span>
            ...
            <div className="border border-[#1a1a1a] bg-white/5 p-10 shadow-sm relative overflow-hidden group">
                ...
                <h4 className="text-[10px] font-mono text-[#1a1a1a]/40 uppercase tracking-widest font-black mb-6">Daily Average</h4>

                <div className="flex items-end gap-3">

                    <span className="text-5xl font-black text-[#1a1a1a] tracking-tighter">{Math.round(avgDailyCalories)}</span>

                    <span className="text-xs font-mono text-[#1a1a1a]/60 mb-2 font-bold italic uppercase">kcal</span>
            ...
            <div className="border border-[#1a1a1a] bg-white/5 p-10 shadow-sm relative overflow-hidden group">
                ...
                <h4 className="text-[10px] font-mono text-[#1a1a1a]/40 uppercase tracking-widest font-black mb-6">Total Sessions</h4>

                <div className="flex items-end gap-3">

                    <span className="text-5xl font-black text-[#1a1a1a] tracking-tighter">{completedFasts.length}</span>

                    <span className="text-xs font-mono text-[#1a1a1a]/60 mb-2 font-bold italic uppercase">Fasts</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="border border-[#1a1a1a] bg-white/10 p-12 shadow-sm">
                ...
                <div className="space-y-10 font-mono">
                    ...
                    <div>
                        ...
                        <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-3 text-[#1a1a1a]">
                            ...
                            <span className="italic">{macroPercentages.protein.toFixed(1)}%</span>

                        </div>

                        <div className="w-full h-3 border border-[#1a1a1a] bg-white/20 overflow-hidden">

                            <div className="h-full bg-[#1a1a1a]/80" style={{ width: `${macroPercentages.protein}%` }} />
                    ...
                    <div>
                        ...
                        <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-3 text-[#1a1a1a]">
                            ...
                            <span className="italic">{macroPercentages.carbs.toFixed(1)}%</span>

                        </div>

                        <div className="w-full h-3 border border-[#1a1a1a] bg-white/20 overflow-hidden">

                            <div className="h-full bg-[#1a1a1a]/50" style={{ width: `${macroPercentages.carbs}%` }} />
                    ...
                    <div>
                        ...
                        <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-3 text-[#1a1a1a]">
                            ...
                            <span className="italic">{macroPercentages.fat.toFixed(1)}%</span>

                        </div>

                        <div className="w-full h-3 border border-[#1a1a1a] bg-white/20 overflow-hidden">

                            <div className="h-full bg-[#1a1a1a]/20" style={{ width: `${macroPercentages.fat}%` }} />
                ...
                <div className="mt-16 p-8 border-l-4 border-[#1a1a1a]/10 bg-[#1a1a1a]/5 italic text-sm text-[#1a1a1a]/60 leading-relaxed">
                    ...
                    "Let food be thy medicine and medicine be thy food." — Observational analysis of systemic nourishment.
                    ...
                    <div className="border border-[#1a1a1a] bg-white/10 p-12 flex flex-col shadow-sm">
                        ...
                        <div className="flex-1 space-y-6 overflow-y-auto max-h-[500px] pr-6 custom-scrollbar-terminal">
                            ...
                            {completedFasts.slice().reverse().map(f => {
                                ...
                                return (
                                    ...
                                    <div key={f.id} className="flex justify-between items-center border-b border-[#1a1a1a]/5 pb-6 group">

                                        <div className="space-y-1">

                                            <div className="text-sm font-black text-[#1a1a1a] uppercase tracking-tighter">

                                                {new Date(f.start).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}

                                            </div>

                                            <div className="text-[10px] font-mono text-[#1a1a1a]/40 font-bold uppercase italic">

                                                {new Date(f.start).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} — {new Date(f.end).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                                        ...
                                        <div className="text-right flex items-center gap-8">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <div className={`text-[9px] font-mono font-black uppercase tracking-widest ${success ? 'text-gray-400' : 'text-[#8b0000]'}`}>
