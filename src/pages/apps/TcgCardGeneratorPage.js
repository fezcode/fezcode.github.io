...
const backgroundOptions = [
  ...
  {value: 'Techno 2', label: 'Matrix (Green/Black)', colors: ['#00ff00', '#000000']},
        ...
        <div className="flex flex-col xl:flex-row gap-10 items-start justify-center">
          ...
          <div className="w-full xl:w-auto flex flex-col items-center sticky top-10">
            <div className="relative group">
              <div
                className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-pink-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
              <canvas
                ref={canvasRef}
