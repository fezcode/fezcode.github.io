          ...
          <div className="relative group">
            ...
            <div className="relative bg-black border border-cyan-500/50 shadow-[0_0_20px_rgba(0,255,255,0.2)] p-1.5 pr-2 gap-2 md:p-2 md:pr-4 md:gap-4 flex items-center overflow-hidden clip-path-polygon">
                ...
                <div className="relative w-10 h-10 md:w-12 md:h-12 flex-shrink-0 border border-cyan-500/50 bg-black overflow-hidden">
                    {currentTrack?.cover ? (
                        ...
                        <div className="w-full h-full">
                            <GenerativeArt seed={currentTrack?.title || "TINY_AETHER"} className="w-full h-full" />
                        </div>
                    )}
                </div>
                ...
                <div className="flex items-center gap-1">
                    ...
                    >
                        <SkipBackIcon size={14} className="md:w-4 md:h-4" weight="bold" />
                    </button>
                    ...
                    >
                        {isPlaying ? <PauseIcon size={14} className="md:w-4 md:h-4" weight="fill" /> : <PlayIcon size={14} className="md:w-4 md:h-4" weight="fill" />}
                    </button>
                    ...
                    <button
                        ...
                        className="p-1.5 md:p-2 hover:bg-cyan-900/30 text-cyan-600 hover:text-cyan-400 transition-colors border border-transparent hover:border-cyan-500/30"
                    >
                        <SkipForwardIcon size={14} className="md:w-4 md:h-4" weight="bold" />
                    </button>
                </div>
            </div>
