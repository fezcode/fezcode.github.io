...
const TimelinePage = () => {
  useSeo({
    ...
    twitterDescription: 'A chronological overview of key milestones and events.',
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 text-gray-300">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <h1 className="text-4xl font-bold font-mono tracking-tight sm:text-6xl mb-4 flex items-center text-white">
              <TimerIcon size={48} weight="duotone" className="mr-4 text-red-400" />
            ...
            <p className="text-gray-400 text-lg max-w-2xl font-mono">
              A journey through key milestones and achievements of Fez<span className="text-primary-400">codex</span>.
            </p>
          </div>
        </div>
        ...
        {loading ? (
            ...
            {[...Array(3)].map((_, i) => (
              <div key={i} className="mb-10 flex items-start">
                ...
                <div className="flex-grow pl-8 md:pl-6">
                  <div className="h-4 bg-gray-700 rounded w-1/4 mb-2 animate-pulse"></div> {/* Date */}
                  <div className="h-6 bg-gray-600 rounded w-3/4 mb-2 animate-pulse"></div> {/* Title */}
                  <div className="h-4 bg-gray-700 rounded w-full mb-1 animate-pulse"></div> {/* Description line 1 */}
                  <div className="h-4 bg-gray-700 rounded w-1/2 animate-pulse"></div> {/* Description line 2 */}
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="relative pl-8 md:pl-20 py-8">
            ...
            <div className="absolute left-4 top-0 h-full w-0.5 bg-gray-800 md:hidden"></div> {/* For smaller screens */}
                ...
                >
                  ...
                  <div className="flex-shrink-0 relative">
                    ...
                    <div
                      ...
                      style={{ backgroundColor: eventColor, transform: 'translateX(-50%)' }}
                    ></div>
                    {/* Icon */}
                    <div
                      className="flex items-center justify-center w-8 h-8 rounded-full border-2 absolute left-4 md:left-20 -top-1"
                      style={{ borderColor: eventColor, backgroundColor: 'rgba(0,0,0,0.4)', transform: 'translateX(-50%)', color: eventColor }}
                    >
                  ...
                  <div className="flex-grow pl-14 md:pl-28">
                    <p className="text-sm text-gray-500 font-mono mb-1" style={{color: `${eventColor}90`}}> {formattedDate} </p>
                    <h2 className="text-xl font-bold font-mono text-gray-100 mb-2" style={{ color: eventColor }} >
                      {milestone.title}
                    </h2>
                    <p className="text-gray-400 font-mono leading-relaxed"> {milestone.description} </p>
                    {milestone.link && (
                      <a
                        href={milestone.link}
                        target="_blank"
