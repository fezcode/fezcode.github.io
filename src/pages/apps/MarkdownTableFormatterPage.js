    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-center gap-4">
          ...
          <h1 className="text-white font-arvo">
            ... Because of Taxi Driver ...
          </h1>
          <TaxiIcon size={24} weight="fill" />
        </div>
        <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
          ...
          <p className="text-sm text-gray-400">
            I watched Taxi Driver (1976). Then I started to write a review, log
            entry for it. Creating a <strong> Markdown Table </strong>is one of
            the hardest parts of writing markdown. Each table row looked worse
            than the previous one. I needed a formatter.
          </p>
          <br />
          <p className="text-sm text-gray-400">
            After hours of writing a React component, finally here it is. It is
            5 AM and I'm <i>finally</i> done.
          </p>
        </div>
      </div>
    );
  ...
  return (
    ...
    <div className="py-16 sm:py-24 min-h-screen bg-[#FFEDCF]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 text-gray-300">
        <Link
          to="/apps"
          className="group text-rose-800 hover:underline flex items-center justify-center gap-2 text-lg mb-4 font-arvo"
        >
        ...
        <div className="flex justify-center items-center mt-16 text-[#1A2E1A]">
          {/*Our Text Div*/}
          <div className="group bg-[#FBF7F0] rounded-[0.25rem] border border-neutral-700 shadow-2xl p-6 flex flex-col justify-between relative transform transition-all duration-300 ease-in-out overflow-hidden h-full w-full max-w-4xl">
            <div
            ...
            <div className="relative z-10 p-1">
              <div className="flex flex-row items-center justify-items-start gap-2">
                ...
                >
                  <BeanieIcon
                    className="rotate-12 hover:rotate-0 transition"
                    size={24}
                  />
                </button>
              </div>
              ...
              {/*Input Text*/}
              <div className="mb-4">
                <label className="block text-2xl font-normal italic text-[#2c3e2c] mb-2 font-playfairDisplay">
                  Input Text
                </label>
