...
export default function Murakami() {
  return (
    <div className="space-y-6 font-mono text-sm leading-relaxed">
      ...
      />
      <p>
        <strong className="text-current">Murakami, Takashi</strong> (村上 隆,
        Murakami Takashi) is a highly influential contemporary Japanese artist,
      ...
      <div className="border border-white/10 p-4 bg-white/[0.02] text-xs text-gray-400">
        <p>
          ...
          art for Kanye West's 2007 album{' '}
          <em className="text-current not-italic">Graduation</em>
