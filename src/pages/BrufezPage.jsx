    ...
    openSidePanel(
      ...
      <div className="space-y-8">
        <div className="p-6 border border-emerald-500/20 bg-emerald-500/5">
          <h4 className="text-emerald-400 font-black uppercase tracking-tighter m-0">
            Live_Data_Buffer
          </h4>
          <p className="text-[10px] font-mono text-gray-500 uppercase mt-2">
            Telemetry stream synchronized with local host.
          </p>
        </div>
        <p className="text-sm font-mono text-gray-400 uppercase leading-relaxed">
          The SidePanel component provides a high-density vertical axis for
          auxiliary process controls and detailed systemic information without
          losing context of the primary matrix.
        </p>
          ...
          <div className="mt-8 flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="space-y-6">
              <p className="text-gray-400 font-mono text-sm max-w-2xl uppercase tracking-widest leading-relaxed">
                Systemic transparency protocol. Celebrated structural logic, 1PX
                borders, and
            ...
            <section className="space-y-8">
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-xl text-gray-300 font-light leading-relaxed">
                  Brufez is a departure from the "soft" web. It rejects rounded
                  corners, subtle gradients, and hidden structures. Instead, it
                  embraces the machine—making the grid visible, the processes
                  transparent, and the feedback absolute.
                </p>
                ...
                <div className="mt-12 space-y-12">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed font-sans m-0">
                      Structure is defined by hard 1PX boundaries. We avoid soft
                      shadows and deep elevations. Every component is anchored
                      to a mathematical grid, emphasizing the "raw" construction
                      of the interface. Corners are sharp (0-2px radius),
                      maintaining a structural integrity that feels like
                      physical hardware.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h4 className="text-white uppercase font-black tracking-tighter text-2xl m-0 flex items-center gap-4">
                      ...
                      Chromatic_Absolutism
                    </h4>
                    <p className="text-sm text-gray-400 leading-relaxed font-sans m-0">
                      The palette is restricted to a high-density black (
                      <span className="text-white font-mono">#050505</span>) and
                      a high-frequency Emerald (
                      <span className="text-emerald-500 font-mono">
                        #10B981
                      </span>
                      ). This dual-tone hierarchy creates extreme contrast,
                      ensuring that "system signals" are immediately
                      distinguishable from static data. Supplemental tones
                      (Rose, Amber) are reserved exclusively for critical
                  ...
                  <div className="space-y-4">
                    <h4 className="text-white uppercase font-black tracking-tighter text-2xl m-0 flex items-center gap-4">
                      ...
                      Systemic_Transparency
                    </h4>
                    <p className="text-sm text-gray-400 leading-relaxed font-sans m-0">
                      Brufez does not hide metadata. Version IDs, process
                      status, and local timestamps are primary UI elements. We
                      use
                      <span className="text-emerald-400 font-mono">
                        {' '}
                        UPPER_SNAKE_CASE
                      </span>{' '}
                      and system syntax (//, ::, []) to treat human-readable
                      text as structured logs, reinforcing the feeling of
                      interacting directly with a digital kernel.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
                  <div className="p-6 border border-white/10 bg-white/5 space-y-4">
                    <h4 className="text-white uppercase font-black tracking-tighter text-lg m-0">
                      Structural Logic
                    </h4>
                    <p className="text-xs text-gray-400 font-mono uppercase m-0">
                      If it exists, it must be bounded. Borders are 1PX solid,
                      highlighting the layout hierarchy.
                    </p>
                  </div>
                  <div className="p-6 border border-emerald-500/20 bg-emerald-500/5 space-y-4">
                    <h4 className="text-emerald-400 uppercase font-black tracking-tighter text-lg m-0">
                      Active Feedback
                    </h4>
                    <p className="text-xs text-gray-400 font-mono uppercase m-0">
                      System states are communicated via color shifts and
                      high-frequency animations (pulses, glitters).
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="space-y-8">
              ...
              <div className="border border-white/10 p-8 md:p-12 space-y-12 bg-white/[0.01] overflow-hidden">
                <div className="space-y-2">
                  ...
                  <h1 className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tighter uppercase leading-none break-words">
                    BRUFEZ_CORE
                  </h1>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter uppercase leading-none break-words">
                    SYSTEM_OVERRIDE
                  </h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8 border-t border-white/5">
                  <div className="space-y-4">
                    ...
                    <p className="font-mono text-sm uppercase tracking-widest text-gray-400 leading-relaxed">
                      Used for metadata, process logs, and technical
                      specifications. High letter-spacing for maximum clarity.
                    </p>
                  </div>
                  <div className="space-y-4">
                    <span className="text-[10px] font-mono text-gray-600 uppercase tracking-[0.3em]">
                    ...
                    <p className="text-lg text-gray-300 font-light leading-relaxed">
                      Used for prose, descriptions, and primary messaging.
              ...
              <div className="grid grid-cols-1 gap-px bg-white/10 border border-white/10">
                {[
                  ...
                  },
                  {
                    ...
                    text: 'text-white',
                    bg: 'bg-rose-500',
                    desc: 'Terminal Warnings',
                  },
                ].map((color) => (
                  <div
                    key={color.name}
                    className="bg-[#050505] p-6 flex items-center justify-between group hover:bg-white/5 transition-colors"
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-12 h-12 border border-white/10 ${color.bg || 'bg-[#050505]'}`}
                      />
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      onClick={() =>
                        addToast({
                          title: 'SYSTEM_SYNC',
                          message: 'SUCCESS: PAYLOAD_SYNC_COMPLETE',
                          type: 'success',
                        })
                      }
                    ...
                    <button
                      onClick={() =>
                        addToast({
                          ...
                          message: 'GOLD: RARE_METRIC_ESTABLISHED',
                          type: 'gold',
                        })
                      }
                    ...
                    <button
                      onClick={() =>
                        addToast({
                          ...
                          message: 'ERROR: REALITY_SYNC_FAILED',
                          type: 'error',
                        })
                      }
                    ...
                    <button
                      onClick={() =>
                        addToast({
                          title: 'LOG_SEQUENCE',
                          message: 'TECHNO: INITIALIZING_BRUFEZ_SPEC',
                          type: 'techno',
                        })
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <button
                    ...
                    className="py-4 border border-white/10 hover:bg-white hover:text-black transition-all font-mono text-[10px] uppercase tracking-widest"
                  >
                    Invoke_Dialog
                  </button>
                  <button
                ...
                <Link to="/brufez/panels" className="block group">
                  <div className="aspect-video w-full border border-white/10 bg-white/[0.02] flex items-center justify-center relative overflow-hidden group-hover:border-emerald-500/50 transition-all">
                    ...
                    <div className="flex flex-col items-center gap-4 z-10">
                      <span className="font-mono text-[10px] text-gray-600 uppercase tracking-[0.5em] group-hover:text-emerald-500 transition-colors">
                        Focal_Matrix
                      </span>
                      <span className="px-3 py-1 bg-white/5 text-[8px] font-mono text-gray-500 group-hover:bg-emerald-500 group-hover:text-black transition-all uppercase">
                        Open_Dual_Panel_View
                      </span>
                    </div>
                  </div>
                </Link>
            ...
            <section className="space-y-8">
              ...
              <div className="bg-black border border-white/10 p-6 font-mono text-xs text-gray-400 space-y-2 overflow-x-auto">
                <div className="flex gap-4">
                  ...
                  <span>
                    <span className="text-emerald-500">const</span> identity ={' '}
                    <span className="text-white">'BRUFEZ'</span>;
                  </span>
                </div>
                <div className="flex gap-4">
                  <span className="text-gray-700">02</span>
                  <span>
                    <span className="text-emerald-500">export default</span>{' '}
                    identity;
                  </span>
                </div>
                <div className="flex gap-4">
      ...
      >
        <div className="space-y-6 py-4">
          <p className="text-sm font-mono text-gray-400 uppercase leading-relaxed m-0">
            Standard container for non-critical information displays. Maintains
            basic structural integrity while allowing for custom children
            blocks.
          </p>
          <div className="h-24 w-full bg-white/5 border border-dashed border-white/10 flex items-center justify-center">
            <span className="font-mono text-[10px] text-gray-600 uppercase tracking-[0.5em]">
              Block_Content
            </span>
          </div>
          <button
