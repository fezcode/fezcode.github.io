...
export const win95 = (ctx, width, height, scale, data) => {
  ...
  ctx.fillText(
    `${repoOwner}`,
    winX + titlePad + 10 * scale,
    winY + titlePad + 28 * scale,
  );
  ...
  ctx.fillRect(logoX, logoY, logoS / 2, logoS / 2);
  ctx.fillStyle = '#00ff00';
  ctx.fillRect(logoX + logoS / 2, logoY, logoS / 2, logoS / 2);
  ctx.fillStyle = '#0000ff';
  ctx.fillRect(logoX, logoY + logoS / 2, logoS / 2, logoS / 2);
  ctx.fillStyle = '#ffff00';
  ctx.fillRect(logoX + logoS / 2, logoY + logoS / 2, logoS / 2, logoS / 2);
  ...
  // Sunken tray
  ctx.fillStyle = white;
  ctx.fillRect(trayX + trayW - 2 * scale, trayY, 2 * scale, trayH); // Right
  ctx.fillRect(trayX, trayY + trayH - 2 * scale, trayW, 2 * scale); // Bottom
  ctx.fillStyle = darkGray;
  ctx.fillRect(trayX, trayY, trayW, 2 * scale); // Top
