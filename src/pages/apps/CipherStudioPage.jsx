  ...
  const applyCaesar = (text, s, decode = false) => {
    ...
    return text.replace(/[a-z]/gi, (char) => {
      ...
      return String.fromCharCode(
        start + ((charCode - start + actualShift) % 26),
      );
    });
  };
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-400 max-w-2xl font-light leading-relaxed">
                Classic message encryption. Choose an algorithm to transform
                your messages into secure character sequences.
              </p>
            </div>
          </div>
        </header>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="p-8 border border-white/10 bg-white/[0.01] rounded-sm flex items-start gap-4">
              ...
              <p className="text-[10px] font-mono uppercase tracking-[0.2em] leading-relaxed text-gray-500">
                These algorithms represent the foundations of cryptography.
                While visually impactful, they are intended for educational and
          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="relative border border-white/10 bg-white/[0.02] p-8 md:p-12 rounded-sm overflow-hidden group">
              <div className="absolute inset-0 opacity-[0.03] pointer-events-none grayscale">
                <GenerativeArt
                  seed={appName + inputText.length + activeCipher}
              ...
              <div className="relative z-10 space-y-12">
                ...
                <div className="relative group/output">
                  ...
                  <div
                    className={`min-h-[12rem] p-8 border border-emerald-500/20 bg-emerald-500/[0.02] rounded-sm font-mono text-lg md:text-xl break-words transition-colors duration-500 ${outputText ? 'text-white' : 'text-gray-800 italic'}`}
                  >
            ...
            <div className="p-8 border border-white/10 bg-white/[0.01] rounded-sm flex items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">
                  Integrity Verified: Processed locally
                </span>
              </div>
              <button
                onClick={() => {
