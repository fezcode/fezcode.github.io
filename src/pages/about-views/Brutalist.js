...
import {ArrowSquareOut, Cpu, HardDrive, ShieldCheck} from '@phosphor-icons/react';
...
const Brutalist = () => {
  ...
  if (loading) {
    return (
      <div className="h-full bg-black flex items-center justify-center">
        <div className="font-mono text-xs uppercase tracking-widest text-white animate-pulse">Initialising_Brutalist_Core...</div>
      </div>
    );
  }
  ...
  return (
    <div
      className="h-full bg-[#050505] text-white overflow-y-auto selection:bg-white selection:text-black font-mono relative">
      ...
      >
        <header className="mb-32 flex flex-col gap-12 border-l-8 border-white pl-8 md:pl-16">
          <div className="flex flex-col gap-2">
             <span className="text-emerald-500 font-black tracking-[0.3em] text-xs uppercase">{'//'} IDENTITY_PRIME</span>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-end">
             ...
             <div className="flex flex-col gap-1 font-mono text-[10px] text-gray-500 uppercase tracking-widest">
                <span className="flex items-center gap-2"><Cpu size={14} /> Neural_Architecture: v0.6.0</span>
                <span className="flex items-center gap-2"><HardDrive size={14} /> Data_Density: Optimized</span>
                <span className="flex items-center gap-2 text-emerald-500"><ShieldCheck size={14} /> Verification: Confirmed</span>
             </div>
          </div>
        </header>
           ...
           <div className="lg:col-span-4 mt-24 lg:mt-0">
              <div className="sticky top-32 space-y-12">
                 <div className="border-8 border-white p-8 bg-white text-black relative overflow-hidden">
                    ...
                    <h3 className="text-4xl font-black uppercase tracking-tighter mb-8 leading-none">Status_Log</h3>
        ...
        <footer
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            <span className="text-white font-black tracking-widest">FEZCODEX_PRIME_NODE</span>
          </div>
        </footer>
      </motion.div>
    </div>
