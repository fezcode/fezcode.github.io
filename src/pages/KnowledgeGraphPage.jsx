    ...
    <div className="relative w-full h-screen bg-[#050505] overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 z-50 pointer-events-none text-white/50 font-mono text-xs">
            ...
            <div className="flex gap-4">
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#f87171]"></span> Post</span>
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#34d399]"></span> App</span>
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#60a5fa]"></span> Project</span>
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#4b5563]"></span> Tag</span>
            </div>
        </div>
        ...
        {hoverNode && (
            <div className="absolute top-6 right-6 z-50 max-w-xs bg-black/80 backdrop-blur-md border border-white/20 p-4 text-white font-mono pointer-events-none">
                <div className="text-xs text-emerald-500 uppercase mb-1">{hoverNode.group}</div>
                <div className="font-bold text-lg mb-2">{hoverNode.name}</div>
                {hoverNode.desc && <div className="text-xs text-gray-400">{hoverNode.desc.substring(0, 100)}...</div>}
            </div>
        )}
