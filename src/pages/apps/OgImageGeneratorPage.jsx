...
const OgImageGeneratorPage = () => {
  ...
  const [description, setDescription] = useState(
    'A short description about the content goes here. Make it catchy!',
  );
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      addToast({
        title: 'Success',
        message: `OG Image generated as ${format.toUpperCase()}.`,
      });
    } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="absolute inset-0 z-10 flex flex-col justify-end p-24">
                      <div className="max-w-4xl space-y-6">
                        ...
                        <div className="flex items-center gap-3 mb-8 opacity-70">
                          ...
                          <span className="font-mono text-xl tracking-[0.2em] uppercase text-emerald-500 font-bold">
                            Fezcodex
                          </span>
                        </div>

                        <h1
                          className="text-7xl font-black text-white leading-[1.1] tracking-tight drop-shadow-xl"
            ...
            <p className="text-center font-mono text-[10px] text-gray-600 uppercase tracking-widest">
              The preview above is scaled down. The generated image will be
              1200x630 pixels.
            </p>
          </div>
        </div>
