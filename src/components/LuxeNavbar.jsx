...
const LuxeNavbar = ({
  ...
  return (
    <header
      className={`sticky top-0 z-40 transition-all duration-500 bg-[#FDFCFB]/80 backdrop-blur-md border-b ${
        isScrolled
      ...
      <div className="mx-auto max-w-[1800px] px-6 md:px-12 flex justify-between items-center text-[#1A1A1A]">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          >
            ...
            <span className="inline font-outfit text-xs font-medium uppercase tracking-widest">
              Search
            </span>
          </button>
        </div>
