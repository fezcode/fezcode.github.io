...
const Planner = ({ data }) => {
  ...
  const handleAddMealToPlan = () => {
    const newMeal = { id: Date.now(), name: 'New Planned Meal', calories: 0, time: '12:00' };
  ...
  const totalPlannedCalories = currentPlan.meals.reduce((sum, m) => sum + (parseInt(m.calories) || 0), 0);
                                        ...
                                        >
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => handleUpdateMealInPlan(meal.id, 'time', e.target.value)}
                                            ...
                                            <div className="md:col-span-6 border-l border-[#1a1a1a]/5 pl-6">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => handleUpdateMealInPlan(meal.id, 'name', e.target.value)}
                                            ...
                                            <div className="md:col-span-3 text-right">
                                                ...
                                                <div className="flex items-center justify-end gap-3">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleUpdateMealInPlan(meal.id, 'calories', e.target.value)}

                                                        className="w-24 bg-transparent border-none text-2xl font-mono font-black text-[#1a1a1a] text-right focus:ring-0 p-0"

                                                    />

                                                    <span className="text-[9px] text-[#1a1a1a]/30 font-mono font-black uppercase tracking-widest">kcal</span>
