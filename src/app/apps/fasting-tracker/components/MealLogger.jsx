      ...
      return (
        ...
        >
          ...
          <div className="space-y-8 py-6 font-arvo text-[#1a1a1a]">
            ...
            <p className="text-[10px] font-mono font-black uppercase tracking-widest border-b border-[#1a1a1a]/10 pb-2">Record what you ate</p>

            <div className="space-y-6">

                <div>

                <label className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest mb-3 font-bold">Pick a Food</label>
                ...
                <div className="grid grid-cols-2 gap-8 animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <label className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest font-bold">Food Name</label>
                    ...
                    <label className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest font-bold">Calories</label>
                ...
                <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <label className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest mb-3 font-bold">How many servings?</label>
                ...
                <label className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest mb-4 font-bold">Meal Type</label>
