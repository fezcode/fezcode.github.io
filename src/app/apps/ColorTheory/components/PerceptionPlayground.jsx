        ...
        <div className="bg-white rounded-3xl p-8 border-2 border-[#1a1a1a] shadow-[8px_8px_0px_0px_#1a1a1a] min-h-[400px] flex items-center justify-center relative overflow-hidden">
            ...
            {activeIllusion === 'contrast' && (
                <div className="flex flex-col items-center gap-8 w-full">
                    <h3 className="text-3xl font-normal font-instr-serif text-[#1a1a1a]">Simultaneous Contrast</h3>
                    <p className="text-[#666] text-center max-w-lg mb-4 text-lg">The small squares are the exact same color (#808080), but they appear different depending on the background.</p>                    <div className="flex gap-0 w-full max-w-2xl h-64">
            ...
            {activeIllusion === 'vibration' && (
                <div className="flex flex-col items-center gap-8 w-full">
                    <h3 className="text-2xl font-bold">Chromatic Vibration</h3>
                     <p className="text-gray-400 text-center max-w-lg mb-4">Bright red and bright blue (or green) create a "vibrating" edge when placed next to each other due to difficulty in focusing on both simultaneously.</p>
             ...
             {activeIllusion === 'mach-bands' && (
                <div className="flex flex-col items-center gap-8 w-full">
                    <h3 className="text-2xl font-bold">Mach Bands</h3>
                     <p className="text-gray-400 text-center max-w-lg mb-4">The visual system exaggerates the contrast at edges of slightly differing shades, creating the illusion of darker or lighter bands.</p>
                    <div className="flex w-full max-w-2xl h-64">
                         {[10, 20, 30, 40, 50, 60, 70, 80].map(l => (
                             <div key={l} className="flex-1" style={{ backgroundColor: `hsl(0, 0%, ${l}%)` }} />
                         ))}
                    </div>
                </div>
            )}
