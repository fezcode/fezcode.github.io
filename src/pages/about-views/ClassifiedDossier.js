    ...
    return (
      <div className="h-full bg-[#f3f3f3] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="font-mono text-xs uppercase tracking-widest">Retrieving Archive...</span>
        </div>
      </div>
    );
  }
      ...
      >
        ...
        <header className="mb-20">
          ...
          <p className="font-mono text-sm text-gray-500 uppercase tracking-wide max-w-lg">
            Subject is a Senior Software Engineer specializing in distributed systems.
        ...
        <footer
          className="mt-32 pt-12 border-t border-black flex flex-col md:flex-row justify-between items-center gap-6 font-mono text-xs uppercase tracking-widest text-gray-500">
