      ...
      <div className="mx-auto max-w-7xl px-6 py-24 md:px-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-400 max-w-2xl font-light leading-relaxed">
                System remediation protocol. Identify and neutralize structural
                anomalies within the neural grid before system stability is
                compromised.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="border border-white/10 bg-white/[0.02] p-8 rounded-sm space-y-10">
              ...
              <div className="space-y-8">
                ...
                <div className="flex justify-between items-end border-b border-white/5 pb-4">
                  ...
                  <span
                    className={`text-4xl font-black ${timeLeft <= 5 ? 'text-red-500 animate-pulse' : 'text-white'}`}
                  >
                    {timeLeft}s
                  </span>
                </div>
            ...
            <div className="p-8 border border-white/10 bg-white/[0.01] rounded-sm">
              <p className="text-[10px] font-mono uppercase tracking-[0.2em] leading-relaxed text-gray-500">
                Operational speed is critical. Bugs mutate rapidly within the
                local environment. Failure to neutralize within the temporal
                window results in system-wide latency.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-8">
            <div className="relative border border-white/10 bg-white/[0.02] p-8 md:p-12 rounded-sm overflow-hidden min-h-[600px] flex items-center justify-center">
              <div className="absolute inset-0 opacity-[0.03] pointer-events-none grayscale">
                <GenerativeArt
                  seed={appName + gameActive + timeLeft}
              ...
              {!gameActive && timeLeft === 0 && (
                ...
                >
                  <div className="space-y-6">
                    <span className="font-mono text-xs text-red-500 font-bold uppercase tracking-[0.5em]">
                      {'//'} SESSION_TERMINATED
                    </span>
                    ...
                    <div className="p-8 border border-white/10 bg-white/5 inline-block rounded-sm">
                      <p className="font-mono text-gray-500 uppercase tracking-widest text-xs mb-2">
                        Final_Mitigation_Count
                      </p>
        ...
        <footer className="mt-32 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-gray-600 font-mono text-[10px] uppercase tracking-[0.3em]">
          ...
          <span className="text-gray-800">
            REMEDIATION_STATUS // {gameActive ? 'IN_PROGRESS' : 'STANDBY'}
          </span>
        </footer>
      </div>
    </div>
