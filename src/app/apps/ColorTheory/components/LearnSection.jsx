  ...
  return (
    <div className="h-full overflow-y-auto p-8 custom-scrollbar">
      <div className="max-w-4xl mx-auto space-y-12 pb-20">
        <header>
          <h2 className="text-5xl font-normal font-instr-serif mb-4 text-[#1a1a1a]">
            Color Theory 101
          </h2>
          <p className="text-xl text-[#4a4a4a] leading-relaxed max-w-2xl font-nunito">
            Understanding the fundamental concepts behind how we see, mix, and
            use color is the first step to mastering design.
          </p>
        </header>
          ...
          {theoryChapters.map((chapter, index) => (
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-3xl font-normal text-[#1a1a1a] font-instr-serif">
                    {chapter.title}
                  </h3>
                  <p className="text-[#666] font-medium font-nunito">
                    {chapter.subtitle}
                  </p>
                </div>
              </div>
