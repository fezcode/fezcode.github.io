import{r as i,j as e,L as de}from"../entries/pages.DoY-3wPt.js";import{S as ce}from"./chunk-B4aSBSKd.js";/* empty css              */import"./chunk-BXl3LOEh.js";/* empty css              */const me=`
...
ships are wrecked.`}],ge="ABCDEFGHIJKLMNOPQRSTUVWXYZ".split(""),he="abcdefghijklmnopqrstuvwxyz".split(""),fe="0123456789".split(""),_e=`.,;:?!'"-—&·/()§¶`.split(""),n=p=>{const s=Math.sin(p*12.9898)*43758.5453;return s-Math.floor(s)},we=()=>{const[p,s]=i.useState(`PRESSED
at the Fezcodex
