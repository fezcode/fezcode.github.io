      ...
      <div className="max-w-[1400px] mx-auto px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-x-20 items-start">
        ...
        <div className="lg:col-span-4 relative">
          ...
          <div className="mt-3 flex gap-1.5 items-center">
            <div className="w-6 h-6 rounded-full border border-black/20 flex items-center justify-center text-[7px] font-bold text-black/60">
              DL
            </div>
            <div className="w-6 h-6 rounded-full border border-black/20 flex items-center justify-center text-[7px] font-bold text-black/60">
              90
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-1 relative">
              ...
              {listItems.map((item, idx) => (
                ...
                >
                  <span
                    className={`text-xl ${idx === 0 ? 'text-black opacity-100' : 'text-black/30'}`}
                  >
                    {idx === 0 ? '✦' : ''}
                  </span>
                  <div className="relative">
                    <span
                      className={`text-[36px] font-medium tracking-tight transition-all ${idx === 0 ? 'text-black' : 'text-black/30 group-hover:text-black/60'}`}
                    >
                      {item}
                    </span>
                    {idx === 0 && (
                      <>
                        ...
                        <div className="absolute left-[-10px] top-[10px] pointer-events-none">
                          ...
                          >
                            <path
                              fill="currentColor"
                              d="M11.5,1.5L12,5L15.5,4.5L14,8L17.5,9.5L14,11L15.5,14.5L12,13L11.5,16.5L11,13L7.5,14.5L9,11L5.5,9.5L9,8L7.5,4.5L11,5L11.5,1.5Z"
